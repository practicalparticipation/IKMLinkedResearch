 ...
 * jQuery SPARQL
 *
 * Adapted for ontowiki from the original at https://github.com/jgeldart/jquery-sparql
 * 
...
(function($){
  ...
  Query.prototype.execute = function(callback) {
    ...
    if(method == "GET") {
      ...
      var url = this.config.endpoint + '?query=' + $.URLEncode(queryString);
      $.ajax({ url: url, dataType: "json", success: _preproc });
      return this;
    }
